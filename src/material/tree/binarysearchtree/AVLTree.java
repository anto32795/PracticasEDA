...
public class AVLTree<E> implements BinarySearchTree<E> {
    ...
    public Iterable<Position<E>> successors(Position<E> pos){
        ...
        for(Position<AVLInfo<E>> n:this.bst.successors((Position<AVLInfo<E>>) pos)){
            rtn.add(n.getElement());
        }
        return rtn;
    }
    public Iterable<Position<E>> predecessors(Position<E> pos){
        List<Position<E>> rtn = new LinkedList<>();
        for(Position<AVLInfo<E>> n:this.bst.predecessors((Position<AVLInfo<E>>) pos)){
            rtn.add(n.getElement());
        }
        return rtn;
    }
