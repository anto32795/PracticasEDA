...
//		}
	...
	public Position<E> first() throws RuntimeException {
		return this.bst.first().getElement();
	}

	public Position<E> last() throws RuntimeException {
		return this.bst.last().getElement();
	}

	public Iterable<Position<E>> successors(Position<E> pos){
		List<Position<E>> rtn = new LinkedList<>();
		var sucesores = this.bst.successors((Position<RBInfo<E>>) pos);
		for(var elem: sucesores){
			rtn.add(elem.getElement());
		}
		return rtn;
	}
	...
	public Iterable<Position<E>> predecessors(Position<E> pos){
		List<Position<E>> rtn = new LinkedList<>();
		var sucesores = this.bst.predecessors((Position<RBInfo<E>>) pos);
		for(var elem: sucesores){
			rtn.add(elem.getElement());
		}
		return rtn;
